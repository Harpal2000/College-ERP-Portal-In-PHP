                                ...
                                <div class="text" style="display:flex; flex-direction: column;color: black;font-size:26px">
                                    <b>YOUR PROFILE</b><span
                                        style="color: #570706 ;font-size:xx-small;margin-top: -10px;"><b>Welcome
                                            to your profile student</b></span>
                                </div>
                            </div>
                        ...
                        <div class="contianer stud-content" style="width:94%">
                            ...
                            <div class="row studForm rounded pb-1 " style="">
                                ...
                                <div class="row border-3   ms-0"
                                    ...
                                    <img class="ms-0 ps-0" src="<?php echo $image_src; ?>" alt="" style="width: 5.8rem; height: 5.4rem;">
                                </div>
                                <div class="row mt-1">
                                    <h6><b>
                                            <?php echo $data['s_name']; ?>
                                    ...
                                    <form class="form-card justify-content-center" onsubmit="event.preventDefault()">
                                        <div class="row justify-content-between text-left my-1">
                                            <div class="form-group  col-sm-6 flex-column d-flex  fields"> <label
                                                    class="form-control-label ">Father Name<span
                                                        class="text-danger"></span></label> <input type="text" class="text-dark"
                                                    id="fname" name="fname" value="<?php echo $data['father_name']; ?>" onblur="validate(1)" disabled
                                                    readonly> </div>
                                            <div class="form-group col-sm-6 flex-column d-flex  fields"> <label
                                                    class="form-control-label ">Mother Name<span
                                                        class="text-danger"></span></label> <input type="text" class="text-dark"
                                                    id="fname" name="fname" value="<?php echo $data['mother_name']; ?>" onblur="validate(1)" disabled
                                                    readonly> </div>
                                        ...
                                        <div class="row justify-content-between text-left my-1">
                                            <div class="form-group col-sm-6 flex-column d-flex  fields"> <label
                                                    ...
                                                    value="<?php echo $data['s_address']; ?>" disabled readonly class="text-dark"
                                                    onblur="validate(2)"> </div>
                                            <div class="form-group col-sm-6 flex-column d-flex fields"> <label
                                                    class="form-control-label ">City<span class="text-danger">
                                                    </span></label> <input type="text" id="mob" name="mob" value=" <?php echo $data['s_city']; ?>"
                                                    disabled readonly class="text-dark" onblur="validate(4)"> </div>
                                        </div>
                                        <div class="row justify-content-between text-left my-1">
                                            <div class="form-group col-sm-6 flex-column d-flex fields"> <label
                                                    class="form-control-label ">Student email<span class="text-danger">
                                                    </span></label> <input type="text" id="email" name="email"
                                                    value="<?php echo $data['s_email']; ?>" disabled readonly class="text-dark"
                                                    onblur="validate(3)"> </div>
                                            <div class="form-group col-sm-6 flex-column d-flex fields"> <label
                                                    class="form-control-label ">Phone number<span class="text-danger">
                                                    </span></label> <input type="text" id="mob" name="mob" value="<?php echo $data['s_phone']; ?>"
                                                    disabled readonly class="text-dark" onblur="validate(4)"> </div>
                                        </div>
                                        <div class="row justify-content-between text-left my-1">
                                            <div class="form-group col-sm-6 flex-column d-flex fields"> <label
                                                    ...
                                                    value="<?php echo $data['s_dob']; ?>" disabled readonly class="text-dark" onblur="validate(3)">
                                            </div>
                                            <div class="form-group col-sm-6 flex-column d-flex fields"> <label
                                                    class="form-control-label ">State<span class="text-danger">
                                                    </span></label> <input type="text" id="mob" name="mob" value="<?php echo $data['s_state']; ?>"
                                                    disabled readonly class="text-dark" onblur="validate(4)"> </div>
                                        </div>
                                        <div class="row justify-content-between text-left my-1">
                                            <div class="form-group col-sm-6 flex-column d-flex fields"> <label
                                                    class="form-control-label ">Country<span class="text-danger">
                                                    </span></label> <input type="text" id="email" name="email" value="<?php echo $data['s_country']; ?>"
                                                    disabled readonly class="text-dark" onblur="validate(3)"> </div>
                                            <div class="form-group col-sm-6 flex-column d-flex fields pb-1"> <label
                                                    class="form-control-label ">Area Pincode<span class="text-danger">
                                                    </span></label> <input type="text" id="mob" name="mob" value="<?php echo $data['s_pincode']; ?>"
                                                    disabled readonly class="text-dark" onblur="validate(4)"> </div>
                                        </div>
                            ...
                            <div class="row align-items-center bg-light mt-2 rounded" style="">
                                ...
                                <div class="row justify-content-between text-left my-2">
                                    <div class="form-group col-sm-6 flex-column d-flex fields"> <label
                                            ...
                                            </span></label> <input type="text" id="email" name="email" value=" <?php echo $data['s_batch']; ?>"
                                            disabled readonly class="text-dark" onblur="validate(3)"> </div>
                                    <div class="form-group col-sm-6 flex-column d-flex fields pb-1"> <label
                                            class="form-control-label ">University Roll No<span class="text-danger">
                                            </span></label> <input type="text" id="mob" name="mob" value=" <?php echo $data['roll_no']; ?>" disabled
                                            readonly class="text-dark" onblur="validate(4)"> </div>
                                </div>
                                <div class="row justify-content-between text-left mb-1">
                                    <div class="form-group col-sm-6 flex-column d-flex fields"> <label
                                            class="form-control-label ">Course-Branch<span class="text-danger">
                                            </span></label> <input type="text" id="email" name="email" value="<?php echo $data['class']; ?>"
                                            disabled readonly class="text-dark" onblur="validate(3)"> </div>
                                    <div class="form-group col-sm-6 flex-column d-flex fields pb-1"> <label
